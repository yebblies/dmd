    ...
    Statement semantic(Scope* sc)
    {
        ...
        case Tstruct:
                ...
                goto Lapply;
            {
                ...
                auto r = new VarDeclaration(loc, null, rid, new ExpInitializer(loc, aggr));
                r.storage_class |= STCtemp;
                Statement _init = new ExpStatement(loc, r);
                // !__r.empty
        ...
        else
        {
            ...
            else if (t.ty == Tstruct)
            {
                if (!exp.isLvalue())
                {
                    ...
                    auto es = new ExpStatement(loc, new DeclarationExp(loc, wthis));
