...
extern (C++) MATCH implicitConvTo(Expression e, Type t)
{
    ...
    public:
        ...
        void visit(SliceExp e)
        {
            ...
            Type tb = t.toBasetype();
            Type typeb = e.type.toBasetype();
            if (tb.ty == Tsarray && typeb.ty == Tarray && e.lwr && e.upr)
            {
...
extern (C++) Expression castTo(Expression e, Scope* sc, Type t)
{
    ...
    public:
        ...
        void visit(Expression e)
        {
            ...
            if ((t1b.ty == Tsarray || t1b.ty == Tstruct) && (tob.ty == Tsarray || tob.ty == Tstruct))
            {
            ...
            if (t1b.ty == Tnull && (tob.ty == Tsarray || tob.ty == Tstruct) || tob.ty == Tnull && (t1b.ty == Tsarray || t1b.ty == Tstruct))
            {
                goto Lfail;
            }
            // Bugzilla 13959: Tstruct <--> Tpointer
            if ((tob.ty == Tstruct && t1b.ty == Tpointer) || (t1b.ty == Tstruct && tob.ty == Tpointer))
            {
                goto Lfail;
            }
            // Bugzilla 10646: Tclass <--> (T[] or T[n])
            if (tob.ty == Tclass && (t1b.ty == Tarray || t1b.ty == Tsarray) || t1b.ty == Tclass && (tob.ty == Tarray || tob.ty == Tsarray))
            {
                goto Lfail;
            }
            ...
            if (t1b.isTypeBasic() && (tob.ty == Tarray || tob.ty == Tsarray || tob.ty == Tclass || tob.ty == Tstruct) || tob.isTypeBasic() && (t1b.ty == Tarray || t1b.ty == Tsarray || t1b.ty == Tclass || t1b.ty == Tstruct))
            {
                goto Lfail;
            }
