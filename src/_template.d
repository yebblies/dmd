...
class TemplateDeclaration : ScopeDsymbol
{
    ...
    this(Loc loc, Identifier id, TemplateParameters parameters,
...
//}
    ...
    abstract void print(_Object oarg, _Object oded);
    abstract void toCBuffer(OutBuffer buf, HdrGenState *hgs);
    abstract _Object specialization();
    abstract _Object defaultArg(Loc loc, Scope *sc);

    /* If TemplateParameter's match as far as overloading goes.
     */
    abstract int overloadMatch(TemplateParameter );

    /* Match actual argument against parameter.
     */
    abstract MATCH matchArg(Scope *sc, Objects tiargs, size_t i, TemplateParameters parameters, Objects dedtypes, Declaration *psparam);
...
class TemplateTypeParameter : TemplateParameter
{
    ...
    void semantic(Scope *);
    void print(_Object oarg, _Object oded);
    void toCBuffer(OutBuffer buf, HdrGenState *hgs);
    _Object specialization();
    _Object defaultArg(Loc loc, Scope *sc);
...
static if (IN_GCC) {
    ...
    this(Loc loc, Identifier temp_id);
    this(Loc loc, TemplateDeclaration tempdecl, Objects tiargs);
...
class TemplateMixin : TemplateInstance
{
    ...
    this(Loc loc, Identifier ident, Type tqual, Identifiers idents, Objects tiargs);
