...
import ddmd.aggregate, ddmd.arraytypes, ddmd.attrib, ddmd.backend, ddmd.cppmangle, ddmd.ctfeexpr, ddmd.dcast, ddmd.dclass, ddmd.declaration, ddmd.dinterpret, ddmd.dmangle, ddmd.doc, ddmd.dscope, ddmd.dstruct, ddmd.dsymbol, ddmd.dtemplate, ddmd.errors, ddmd.expression, ddmd.func, ddmd.globals, ddmd.hdrgen, ddmd.id, ddmd.identifier, ddmd.init, ddmd.inline, ddmd.intrange, ddmd.mtype, ddmd.opover, ddmd.root.outbuffer, ddmd.root.rootobject, ddmd.statement, ddmd.target, ddmd.tokens, ddmd.visitor;
...
public:
    ...
    final bool checkNestedReference(Scope* sc, Loc loc)
    {
        ...
        if (parent && !isDataseg() && parent != sc.parent && !(storage_class & STCmanifest))
        {
...
extern (C++) final class ClassInfoDeclaration : VarDeclaration
{
public:
    ClassDeclaration cd;

    /********************************* ClassInfoDeclaration ****************************/
    extern (D) this(ClassDeclaration cd)
    {
        super(Loc(), Type.typeinfoclass.type, cd.ident, null);
        this.cd = cd;
